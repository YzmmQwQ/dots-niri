...
Item {
    ...
    // Use NiriData instead of Hyprland
    readonly property var focusedOutput: NiriData.focusedOutput
    readonly property Toplevel activeWindow: ToplevelManager.activeToplevel
    readonly property int effectiveActiveWorkspaceId: NiriData.focusedWorkspace?.id ?? 1
    ...
    WheelHandler {
        onWheel: (event) => {
            if (event.angleDelta.y < 0)
                NiriConfig.focusWorkspace(NiriData.focusedWorkspace.id + 1)
    ...
    MouseArea {
        ...
        onPressed: (event) => {
            if (event.button === Qt.BackButton) {
                // Niri doesn't have special workspace like Hyprland
                // Could use focus-workspace-previous instead
    ...
    Grid {
        ...
        Repeater {
            ...
            Button {
                ...
                onPressed: NiriConfig.focusWorkspace(workspaceValue)
                ...
                background: Item {
                    ...
                    implicitWidth: workspaceButtonWidth
                    implicitHeight: workspaceButtonWidth
                    property var biggestWindow: NiriData.biggestWindowForWorkspace(button.workspaceValue)
